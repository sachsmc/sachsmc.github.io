...
*Sounds like a job for pseudo-observations!* 🦸
...
- The computed pseudo-observations are returned in the `y` element of any object of class `pseudoglm`. They can be used for other fun things, e.g., estimating relative survival as per Pavlič and Pohar Perme (2019)
...
Paper to appear in _Journal of Statistical Software_

Sachs MC, Gabriel EE. eventglm: Regression Models for Event History Outcomes; 2021. R package version 1.2.1; https://cran.r-project.org/package=eventglm.
...
Erichsen R, Olén O, Sachs MC, Pedersen L, Halfvarson J, Askling J, Ekbom A, Ludvigsson JF, Sørensen HT. Hepatobiliary Cancer Risk in Patients with Inflammatory Bowel Disease: A Scandinavian Population-Based Cohort Study. _Cancer Epidemiology and Prevention Biomarkers_. 2021 May 1;30(5):886-94.
