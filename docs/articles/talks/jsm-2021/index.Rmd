---
title: "Emulating a target trial to evaluate the clinical utility of a biomarker-based treatment rule"
subtitle: "Joint Statistical Meetings"
...
knitr::include_graphics("kmonco.png")
```
...
knitr::include_graphics("jblfig.png")
```
...
`r knitr::include_graphics("qrjob.png")`
