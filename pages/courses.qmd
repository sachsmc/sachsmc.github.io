...
listing:
  ...
  contents:
    - title: Programming and Statistical Modeling in R
      path: https://sachsmc.github.io/r-programming/
    ...
    - title: Theory of survival analysis using counting processes
      path: https://sachsmc.github.io/surv-theory-course/
    ...
    - title: Applied Causal Inference
      path: https://sachsmc.github.io/applied-causal-inference/
    ...
    - title: R package development workshop
      path: https://sachsmc.github.io/rpackage-workshop/index.html
    ...
    - title: Using the `eventglm` R package for regression modeling of censored time-to-event outcomes
      path: https://sachsmc.github.io/eventglm-tutorial/index.html
